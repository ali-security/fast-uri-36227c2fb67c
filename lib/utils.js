  ...
  if (component.host !== undefined) {
    ...
    if (!isIPv4(host)) {
      ...
      if (ipV6res.isIPV6 !== true && ipV6res.isIPVFuture !== true) {
        // Decode once, and only after a valid IP literal has been ruled out:
        // decoding first would turn an escape inside a zone identifier into a
        // second live byte during recomposition.
        host = unescape(host)
